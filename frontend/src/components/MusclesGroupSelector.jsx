...
import './styles/MusclesGroupSelector.css'

const MusclesGroupSelector = ({ selectedMuscles, onMuscleChange }) => {
    const handleChangeInput = (event) => {
        let id = event.target.id;
        let paths = document.querySelectorAll(`.svg-container svg #${id.charAt(0).toUpperCase() + id.slice(1)} path`);
    ...
    useEffect(() => {
        const handleMouseOver = (event) => {
          let id = event.target.closest('g[id]').id.toLowerCase();
        ...
        const handleClick = (event) => {
          ...
          if (input) {
            ...
            // Trigger the change event to ensure the label updates correctly
        ...
        const groups = document.querySelectorAll('.muscle-groups .svg-container svg g g[id]');
        ...
        const inputs = document.querySelectorAll('.muscle-groups input');
        ...
        return () => {
          groups.forEach((group) => {
            group.removeEventListener('mouseover', handleMouseOver);
            group.removeEventListener('mouseout', handleMouseOut);
...
export default MusclesGroupSelector;